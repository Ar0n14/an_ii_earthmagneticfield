...
Ondanks het feit dat de aarde een magneetveld heeft, met allerlei alledaagse toepassingen, wordt het vaak slecht begrepen. [GESTOLEN]Historisch gezien is de belangrijkste toepassing van het magneetveld navigatie.
...
Dit is een stroom geladen deeltjes afkomstig van de zon, die schadelijk zou zijn voor het leven op aarde \cite{aron_book_ch2}.[GESTOLEN] Het magnetisch veld heeft een meetbare structuur en een fysieke oorsprong.
...
\begin{figure}[hbt!]
    ...
    \caption{Indien er een extern magnetisch veld is, zal er in de detectiespoel een wisselspanning optreden. In dat geval is de spanning in functie van de tijd een sinusfunctie. Deze figuur geeft zo'n sinusfunctie weer.}
    \label{fig:tjalling2}
\end{figure}
